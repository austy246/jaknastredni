...
JPZ nový formát (2024–2026) je ověřen a naimportován, viz oddíl 14.

## 14. Porovnání hlaviček JPZ nový formát 2024–2026 (ověřeno před importem importéru `cermat_jpz.py`)
...
## Přílohy
Regionální/oborové agregace (oddíl 3) zůstaly jen ve scratchpadu průzkumu,
mimo repo (agregace na úrovni kraj × typ školy, ne po jednotlivých školách,
mimo scope importérů výše):
...
souborů) a JPZ nového formátu
`PZ{2024,2025,2026}_kolo{1,2}_skolobory_{vysledky,prihlasky,kapacity}.xlsx`
